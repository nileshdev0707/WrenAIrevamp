  ...
  return (
    <section className="relative overflow-hidden text-center md:pt-24 md:pb-24 pt-20 sm:pb-10 py-5 sm:px-6 px-4">
      ...
      <div className="relative max-w-6xl mx-auto md:mt-25 sm:mt-10 mt-5">
        <div className="inline-block text-sm sm:text-base bg-gradient-to-r from-[#0B8EE5] to-[#0022CB] text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full shadow-sm animate-fade-in-up">
          {badge}
        </div>
