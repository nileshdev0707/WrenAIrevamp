          ...
          {features.coreCapabilitieList.map((item, index) =>
            item.size === "lg" ? (
              <div
                ...
                className={`${
                  index === 0
                    ? "bg-[linear-gradient(90deg,#000000_0%,#101B52_63%,#1A2B85_100%)] before:content-[''] before:absolute before:inset-0 before:-m-2   before:rounded-2xl before:bg-[linear-gradient(27deg,#0B8EE5_0%,#2D50FF_50%,#8F3BFF_100%)] before:blur-xl before:opacity-70 before:-z-10"
                    : "bg-[#060A1F] fade-card"
                  ...
                  <div className="space-y-3">
                    {item.bullets.map((feature, featureIndex) => (
                      ...
                      >
                        ...
                        <p className="sm:text-base text-sm text-[#F3F3F3]">
                          {feature}
                        </p>
                      </div>
                    ))}
