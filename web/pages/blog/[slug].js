      ...
      <article className="max-w-6xl mx-auto py-12">
        ...
        <div className="md:grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-20 pt-5 px-5">
          ...
          <div className="col-span-1">
            ...
            <div classNamee="bg-white rounded-lg mt-5">
              <h2 classNamee="xl:text-2xl md:text-xl text-lg font-semibold mb-6">
                Related Posts
              </h2>
                <div classNamee="space-y-8">
                {post.relatedPosts.map((post) => (
                  <div classNamee="space-y-2">
                    <Link href={`/blog.js/${post.slug}`}>
                    <span classNamee="mb-4 inline-block px-3 py-2 text-xs font-medium bg-gray-100 text-gray-700 rounded-md">
                      {post?.publishedAt
                    ...
                    <h3 classNamee="font-semibold text-gray-900">{post.title}</h3>
                    <p classNamee="text-sm text-gray-600">{post.excerpt}</p>
                    </Link>
                    </div>
                ))}
              </div>
