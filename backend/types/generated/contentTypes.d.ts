...
export interface ApiCapabilitiesCapabilities extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'home-capabilities';
    singularName: 'capabilities';
  };
  options: {
...
export interface ApiFeatureShowcaseFeatureShowcase
  ...
  info: {
    ...
    pluralName: 'feature-showcases';
    singularName: 'feature-showcase';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::feature-showcase.feature-showcase'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiLogosLogos extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::logos.logos'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  collectionName: 'home_navigation';
  info: {
...
export interface ApiPricingPricing extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bottomContentBlock: Schema.Attribute.DynamicZone<
      ['shared.bottom-content-block']
    >;
    ContentBlock: Schema.Attribute.DynamicZone<['shared.content-block']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    frequentlyAskedQuestions: Schema.Attribute.Component<
    ...
    TrustedBy: Schema.Attribute.DynamicZone<['sections.logos-section']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStatsStats extends Struct.SingleTypeSchema {
  collectionName: 'home_stats';
  info: {
    displayName: 'stats';
    pluralName: 'stats-list';
    singularName: 'stats';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::stats.stats'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
